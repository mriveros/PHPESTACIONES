        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				...
				<div class="modal-header"><button type="button" class="close" data-dismiss="modal">
					...
					<h3 class="modal-title" id="myModalLabel"><i class="fa fa-archive"></i>Registro Departamentos por Fecha</h3>
				</div>
            
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="InfDepartamentoFecha.php" method="post" role="form">
