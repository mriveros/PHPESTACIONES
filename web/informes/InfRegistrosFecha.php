...
function Header()
{
   // Select Arial bold 15
    ...
    $this->text(65,60,'Registros de Estaciones por Fechas');//Titulo
...
$pdf->Cell(20,10,'Cantidad',1,0,'C',50);
$pdf->Cell(15,10,'Aprob.',1,0,'C',50);
$pdf->Cell(15,10,'Reprob.',1,0,'C',50);
$pdf->Cell(15,10,'Claus.',1,0,'C',50);
$pdf->Cell(45,10,'Usuario',1,0,'C',50);
...
cli.cli_nom||' '||cli.cli_ape as cliente,
...
and reg.reg_fecha <= '$hasta' order by reg_fecha,cliente");
...
{   $cliente=pg_result($consulta,$i,'cliente');
    ...
    $pdf->Cell(15,5,$aproba,1,0,'C',$fill);
    $pdf->Cell(15,5,$reprob,1,0,'C',$fill);
    $pdf->Cell(15,5,$claus,1,0,'C',$fill);
    $pdf->Cell(45,5,$usuario,1,0,'L',$fill);
