 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Tecnico en el Laboratorio ya existe. Intente ingresar otro Tecnico o Laboratorio");
                window.location="http://192.168.0.99/web/phpestaciones/web/tecnicos_laboratorios/ABMtecniLab.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://192.168.0.99/web/phpestaciones/web/tecnicos_laboratorios/ABMtecniLab.php");
                }
            }
        //si es Modificar    
