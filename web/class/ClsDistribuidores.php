...
$codusuario=  $_SESSION["codigo_usuario"];
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Distribuidor ya existe. Intente ingresar otro Distribuidor");
                window.location="http://192.168.0.99/web/phpestaciones/web/distribuidores/ABMdistribuidor.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://192.168.0.99/web/phpestaciones/web/distribuidores/ABMdistribuidor.php");
                }
            }
        //si es Modificar    
